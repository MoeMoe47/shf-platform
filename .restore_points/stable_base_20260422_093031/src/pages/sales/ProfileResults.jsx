...
import model from "@/data /sales/issues.v1.json";
    ...
    return (
      <section className="crb-main">
        ...
        <div className="card card--pad">
          No profile yet. <a className="sh-btn sh-btn--soft" href=" /sales.html#/survey">Take the survey</a>.
        </div>
      </section>
    );
  }
    ...
    <section className="crb-main">
      <header className="db-head">
        ...
        <div style={{display:"flex", gap:8}}>
          <a className="sh-btn sh-btn--soft" href=" /sales.html#/survey">Retake Survey</a>
...
import PortfolioHint from "@/components /sales/PortfolioHint.jsx";
