...
export default function AgentSyncStatus({
        ...
        const res = await fetch(
          `${AGENT_BASE}/admin/agents/ai_analyst_agent/page-context-dry-run`,
          {
            ...
            body: JSON.stringify({
              ...
              page,
              goal:
                "Keep AI Analyst synchronized with SHF entity, clicked county, map mode, and Oracle truth context.",
              selected_state: {
  ...
  }, [entityId, selectedCounty, surface, page, truthPayload, mapCountyContext]);
