...
const SHS_PRODUCTION_HARDENING_SAMPLE_FILES = [
  "src/router/AdminRoutes.jsx",
  "src/router/AdminRoutes.jsx.bak_route_protection_20260513_072505",
  "src/pages/exchange/SHSCommandSurface.jsx.broken_now",
  "src/auth/AuthGuard.jsx",
  "apps/shs-api/src/auth/permission-guard.ts",
  "apps/shs-api/src/api/router.ts.bak_20260424_105156",
  "src/pages/admin/reporting/BriefingExportPanel.jsx",
  "src/pages/admin/reporting/AnalystMemoExportPanel.jsx",
  "src/pages/lordOutcomes/LordOutcomesHome.jsx",
];

function ProductionHardeningSurface() {
  const model = buildProductionHardeningAuditModel({
    source: "lord_outcomes_home",
    files: SHS_PRODUCTION_HARDENING_SAMPLE_FILES,
    placeholderFindings: [],
    consoleFindings: [],
    importFindings: [],
    ...
    <section className={["lo-productionHardening", productionHardeningStatusClass(model.hardeningStatus)].join(" ")}>
      ...
      <div className="lo-productionHardening__riskPanel">
        <div className="lo-productionHardening__riskHeader">
          <strong>Cleanup risk view</strong>
        ...
        <div className="lo-productionHardening__riskList">
          {model.archiveCandidates.slice(0, 6).map((file) => (
      ...
      <div className="lo-productionHardening__decision">
        <div>
          ...
          <p>
            SHS V1 is structurally locked and build-valid, but backup and broken-risk files should be archived out of the active source tree before production signoff.
          </p>
        </div>
