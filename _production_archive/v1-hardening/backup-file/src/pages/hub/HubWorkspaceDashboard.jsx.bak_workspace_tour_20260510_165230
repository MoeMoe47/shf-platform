...
function Rail() {
  ...
  return (
    <aside className="hubV1-rail">
      <button className="hubV1-logo" type="button" onClick={() => (window.location.href = SHS_HOME_URL)} title="Go to Silicon Heartland Solutions">
        <img
          src={HUB_LOGO_PATH}
          alt={HUB_LOGO_ALT}
          onError={(event) => {
...
function Header() {
  ...
  return (
    <header className="hubV1-header">
      <div>
        <h1>Silicon Heartland Hub</h1>
        <p>Hub Workspace Dashboard</p>
      </div>

      <div className="hubV1-headerActions">
      ...
      <div className="hubV1-profileWrap">
...
function NetworkSnapshot() {
  ...
  return (
    <section className="hubV1-card hubV1-network">
...
function OperationsWorkspace() {
  return (
    <section className="hubV1-card hubV1-operations">
      ...
      <div className="hubV1-tileGrid">
        {workspaceTiles.map(([label, icon, path, count, state]) => (
          <button
            key={label}
            type="button"
...
function RecentActivity() {
  return (
    <section className="hubV1-card hubV1-activity">
      <div className="hubV1-sectionHead">
        <div>
...
function AdaptiveExperienceCard({ adaptive }) {
  ...
  return (
    <section className="hubV1-card hubV1-rightCard hubV1-adaptiveCard">
      <div className="hubV1-sectionHead">
        <div>
  ...
  return (
    <main className="hubV1-shell" onClickCapture={handleAdaptiveClickCapture}>
      ...
      <section className="hubV1-page">
        ...
        <section className="hubV1-kpiRow">
