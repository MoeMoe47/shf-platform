...
INSERT INTO role_permissions (role_permission_id, role_id, permission_name) VALUES
 ...
 ('phase8_inst_cohort','phase8_role_instructor','cohort.view'),('phase8_inst_assignment','phase8_role_instructor','assignment.view'),('phase8_inst_project','phase8_role_instructor','project.submission.review'),('phase8_inst_verify_view','phase8_role_instructor','verification.view'),('phase8_inst_verify_review','phase8_role_instructor','verification.review'),('phase8_inst_verify_approve','phase8_role_instructor','verification.approve'),('phase8_inst_live','phase8_role_instructor','liveLearning.view'),('phase8_inst_attendance','phase8_role_instructor','liveLearning.join.authorize'),('phase8_inst_reports','phase8_role_instructor','reports.view'),
 ('phase8_student_assignment','phase8_role_student','assignment.view'),('phase8_student_enrollment','phase8_role_student','enrollment.view'),('phase8_student_live','phase8_role_student','liveLearning.view'),('phase8_student_join','phase8_role_student','liveLearning.join.request'),('phase8_student_project','phase8_role_student','project.submission.write'),('phase8_student_arcade','phase8_role_student','arcade.attempt'),('phase8_student_complete','phase8_role_student','curriculum.lesson.complete') ON CONFLICT DO NOTHING;
