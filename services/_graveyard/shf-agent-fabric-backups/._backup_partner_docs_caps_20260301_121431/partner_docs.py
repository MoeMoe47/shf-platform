...
def funding_capabilities() -> Dict[str, Any]:
    """
    Partner-friendly discovery doc. Full truth remains OpenAPI at /openapi.json.
    Keep this stable; partners will code against it.
    """
    
    endpoints = [
        {"path": "/api/funding/health", "methods": ["GET"], "description": "Funding service health check."},
        {"path": "/api/funding/capabilities", "methods": ["GET"], "description": "API discovery document."},
        {"path": "/api/funding/discovery", "methods": ["GET"], "description": "Union index of funding artifacts."},
        {"path": "/api/funding/rulesets", "methods": ["GET"], "description": "Ruleset index."},
        {"path": "/api/funding/rulesets/{ruleset_id}", "methods": ["GET"], "description": "Fetch ruleset by id."},
        {"path": "/api/funding/lock-triggers", "methods": ["GET"], "description": "Lock trigger index."},
        {"path": "/api/funding/lock-triggers/{ruleset_id}", "methods": ["GET"], "description": "Fetch lock triggers."},
        {"path": "/api/funding/schemas", "methods": ["GET"], "description": "Funding contract schemas."},
        {"path": "/api/funding/examples", "methods": ["GET"], "description": "Example simulation payloads."},
        {"path": "/api/funding/simulate", "methods": ["POST"], "description": "Outcome funding simulation."},
        {"path": "/api/funding/sdk", "methods": ["GET"], "description": "Partner quickstart SDK examples."},
        {"path": "/api/funding/version", "methods": ["GET"], "description": "Funding API version metadata."},
        {"path": "/api/funding/changelog", "methods": ["GET"], "description": "Funding API change history."}
    ]
, "description": "Funding service health check."},
        {"path": "/api/funding/capabilities", "methods": ["GET"], "description": "API discovery document."},
        {"path": "/api/funding/discovery", "methods": ["GET"], "description": "Union index of funding artifacts (rulesets + lock triggers)."},
        {"path": "/api/funding/rulesets", "methods": ["GET"], "description": "Ruleset-only index (AIM_RULESET_V1 items)."},
        {"path": "/api/funding/rulesets/{ruleset_id}", "methods": ["GET"], "description": "Fetch a single ruleset JSON by id."},
        {"path": "/api/funding/lock-triggers", "methods": ["GET"], "description": "Lock-trigger-only index (AIM_LOCK_TRIGGERS_V1 items)."},
        {"path": "/api/funding/lock-triggers/{ruleset_id}", "methods": ["GET"], "description": "Fetch a single lock-triggers JSON by id."},
        {"path": "/api/funding/schemas", "methods": ["GET"], "description": "Partner-friendly schema index (shape docs)."},
        {"path": "/api/funding/examples", "methods": ["GET"], "description": "Example payloads and responses."},
        {"path": "/api/funding/simulate", "methods": ["POST"], "description": "Run payout simulation for a cohort against a ruleset."},
    ...
    return {
        ...
        "examples": {
            "curl": [
                ...
                "curl -sS http://127.0.0.1:8001/api/funding/sdk | python3 -m json.tool",
                "curl -sS http://127.0.0.1:8001/api/funding/postman | python3 -m json.tool | head",
        ...
        "notes": [
            ...
            "No secrets are exposed. Safe to share with partners.",
            "Full truth remains OpenAPI at /openapi.json.",
        ],
    }
