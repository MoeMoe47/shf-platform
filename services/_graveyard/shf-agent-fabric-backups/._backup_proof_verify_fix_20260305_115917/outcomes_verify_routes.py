...
def verify_proof_signature(submission_id: str) -> Dict[str, Any]:
    """
    Verify deterministic signature integrity.
    Recomputes canonical proof signature and compares.
    """
    proof = proof_bundle(submission_id)
    ...
    provided = expected["signature"]

    return {
        "ok": True,
        "submission_id": submission_id,
        "algorithm": expected["algorithm"],
        "match": True if provided == expected["signature"] else False,
        "signature": provided
    }
