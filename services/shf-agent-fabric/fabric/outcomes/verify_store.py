...
from fabric.credits.store import get_credit_by_submission, create_credit
from fabric.payouts.store import get_intent_by_credit, create_payout_intent
...
def upsert_verify_bundle(
    ...
    payout_intent = create_payout_intent(
        intent_id=intent_id,
        credit_id=credit_id,
