...
from fabric.funding.manifest_signed import build_manifest, sign_manifest
@router.get("/postman")
...
@router.get("/manifest")
def funding_manifest() -> dict:
    """
    Signed ruleset manifest:
    - lists every ruleset JSON filename + sha256(file_bytes)
    - signs stable JSON using ed25519
    """
