    ...
    <div className="kb-overlay" onClick={(e)=>{ if (e.target === e.currentTarget) onClose?.(); }}>
      <div className="kb-card" role="dialog" aria-modal="true" aria-label="Add Note">
        ...
        <textarea
          ...
          placeholder="Capture a lead insight, objection, or next step."
          value={text}
  ...
  const addToPortfolio = React.useCallback(() => {
    ...
    try {
      ...
      const artifact = {
        ...
        kind: "lesson",
        title: vLesson?.title || `Sales Lesson ${id}`,
        lessonId: id,
        createdAt: Date.now(),
        tags: ["sales", "lesson"],
        pathwayId: null,
            ...
            <div className="sh-cardBody">
              ...
              <div className="sh-cardContent">
                ...
                <textarea
                  ...
                  placeholder={"What pipeline actions will you take next week (X new prospects, Y discovery calls, Z demos, follow-ups to close)? 📈🤝"}
                />
