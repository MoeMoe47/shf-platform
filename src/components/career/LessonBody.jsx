// src/components/career/LessonBody.jsx
...
/* --------------------------------------------- */
/* MicroQuiz (same API as other apps)            */
/* --------------------------------------------- */
    ...
    <div className="kb-overlay" onClick={(e)=>{ if (e.target === e.currentTarget) onClose?.(); }}>
      <div className="kb-card" role="dialog" aria-modal="true" aria-label="Add Note">
        ...
        <textarea
          ...
          placeholder="Capture a career idea, person to contact, or next action."
          value={text}
  ...
  const addToPortfolio = React.useCallback(() => {
    ...
    try {
      ...
      const artifact = {
        ...
        kind: "lesson",
        title: vLesson?.title || `Career Lesson ${id}`,
        lessonId: id,
        createdAt: Date.now(),
        tags: ["career", "lesson"],
        pathwayId: null,
            ...
            <div className="sh-cardBody">
              ...
              <div className="sh-cardContent">
                ...
                <textarea
                  ...
                  placeholder={"What’s your next concrete step (update resume, reach out to 3 contacts, apply to 2 roles, add a cert)? 🚀"}
                />
