...
export default function MetaverseDistrictPulse({ pulses = [], open = false }) {
  const relevant = pulses.filter((pulse) => pulse.learner_relevant_count > 0 || pulse.has_next_action);
