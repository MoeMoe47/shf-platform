...
// FundingCalculator.jsx, with one fix: gotoProposal() navigated to
// "/sales/demo-proposal" — the app's own routes are unprefixed (this file
// mounts inside sales.html's own router), so that never matched any
// registered route. Fixed to "/demo/proposal", the route this restoration
// actually registers for DemoProposal.jsx.
