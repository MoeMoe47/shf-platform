...
export default function AlignmentSwitchboard() {
  ...
  .sh-btn{padding:9px 12px;border-radius:12px;border:1px solid rgba(255,255,255,0.15);background:rgba(255,255,255,0.10);color:rgba(255,255,255,0.92);font-weight:700}
