...
export default function AnalystPredictionCard({ agentContext, agentAudience, onExecuteAction }) {
  ...
  const executeRecommended = () => {
    const payload = {
      type: recommendedAction,
      source: "analyst_prediction",
      riskScore,
      riskLabel,
      likelyNext,
      thenStep: secondStep,
