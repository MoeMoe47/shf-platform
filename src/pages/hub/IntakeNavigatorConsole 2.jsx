...
export default function IntakeNavigatorConsole() {
  ...
  async function handleCreateReferral() {
    ...
    try {
      const response = await fetch("/api/hub/referrals", {
        method: "POST",
        headers: {
      ...
      console.warn("[SHS Hub Intake] Referral create fallback:", error);
      setDraftState("Ready to Submit");
      alert("Referral draft is ready. Backend create endpoint may need to be connected.");
    }
  }

  return (
    <main className="intakeShs-shell">
      <aside className="intakeShs-rail">
        <button className="intakeShs-logo" type="button" onClick={() => go("/hub")}>
          SHH
        </button>

        <nav className="intakeShs-nav">
          <button type="button" onClick={() => go("/hub")}>
            <span>⌂</span>
          ...
          <button type="button" onClick={() => go("/reporting")}>
            <span>▥</span>
            <small>Reports</small>
          </button>
        </nav>

        <section className="intakeShs-readiness">
      ...
      <section className="intakeShs-page">
        <header className="intakeShs-header">
          <div>
          ...
          <div className="intakeShs-actions">
            <button type="button" onClick={() => go("/hub")}>← Back to Hub</button>
        ...
        <section className="intakeShs-formCard">
          <div className="intakeShs-field">
          ...
          <div className="intakeShs-priority">
        ...
        <section className="intakeShs-supportGrid">
          <article className="intakeShs-card">
            ...
            <button type="button" onClick={() => go("/hub/network")}>View organizations →</button>
          </article>
          ...
          <article className="intakeShs-card">
            ...
            <button type="button">Review draft summary →</button>
          </article>
          ...
          <article className="intakeShs-card">
            ...
            <button type="button">View routing playbook →</button>
          </article>
        </section>

        <section className="intakeShs-consent">
