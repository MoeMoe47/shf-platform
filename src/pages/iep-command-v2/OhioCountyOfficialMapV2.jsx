...
export default function OhioCountyOfficialMapV2({
  ...
  const mapState = useMemo(() => {
    ...
    const projection = geoMercator().fitExtent(
      [
        [44, 24],
        [VIEWBOX_WIDTH - 44, VIEWBOX_HEIGHT - 42],
      ],
      geojson
    );
