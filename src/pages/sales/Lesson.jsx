...
//
// Restored from src/_archive/pages.sales.20251107-000126/Lesson.jsx.
// Delegates to src/components/sales/LessonBody.jsx, which already exists
// in the current tree (production-quality, same proven pattern as the
// Career/Civic LessonBody variants — objectives, vocab, scored quiz,
// reflection, progress, rewards, correctly namespaced "sales:*").
