...
export const universeDestinations = [
  ...
  // is the curation tool for this very list, not a distinct destination.
  {
    ...
    availability: 'available-local',
    publicNavigationStatus: 'available',
    productionPath: '/career.html#/dashboard',
    sourceEvidence: 'src/data/apps.registry.js ("Career Center") + career.html title "SHF Career" + src/router/CareerRoutes.jsx (public, no auth wrapper)',
