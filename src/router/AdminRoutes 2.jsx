  ...
  return (
    <AuthGuard>
      <Routes>
        ...
        {/* SHS Hub */}
        <Route path="/hub" element={<HubWorkspaceDashboard />} />
        <Route path="/hub/network" element={<HubLeadershipDashboard />} />
        <Route path="/hub/leadership" element={<HubLeadershipDashboard />} />
        ...
        <Route path="/hub/referrals" element={<ReferralLifecycleView />} />
        <Route path="/hub/unmet-needs" element={<UnmetNeedsQueue />} />
        <Route path="/hub/imports" element={<HubFilesImports />} />
        <Route path="/hub/reports" element={<HubReports />} />

        {/* Shared SHS admin/infrastructure surfaces */}
        <Route path="/uploads" element={<UploadManager />} />
        <Route path="/imports" element={<HubFilesImports />} />
        <Route path="/aggregation" element={<AggregationDashboard />} />
        <Route path="/reporting" element={<ReportingCommandSurface />} />
        <Route path="/verification-audit" element={<VerificationAuditSurface />} />
        ...
        <Route path="/grant-binder" element={<GrantBinder />} />
        <Route path="/alignment" element={<AlignmentSwitchboard />} />

        {/* Partner Growth Engine */}
        <Route path="/growth" element={<SHSPartnerGrowthEngine />} />

        {/* Fallback */}
        <Route path="*" element={<Navigate to="/hub" replace />} />
      
        <Route path="/solutions" element={<SolutionsInfrastructurePage />} />
        <Route path="/solutions/infrastructure" element={<SolutionsInfrastructurePage />} />
