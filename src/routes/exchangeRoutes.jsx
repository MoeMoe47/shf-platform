...
const UnifiedTruthMapRoute = lazy(() => import("@/pages/exchange/unified-truth/UnifiedTruthMapRoute"));
...
export default function ExchangeRoutes() {
  return (
    <Route path="exchange" element={withExchangeLazyBoundary(<ExchangeLayout />)}>
      ...
      <Route path="unified-truth" element={withExchangeLazyBoundary(<UnifiedTruthMapRoute />)} />
      <Route path="truth" element={withExchangeLazyBoundary(<UnifiedTruthMapRoute />)} />
