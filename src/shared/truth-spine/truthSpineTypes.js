...
// ---------- TRUTH SPINE EVENT TYPES ----------
// Kept for event log compatibility.
// These are operational audit events, not Oracle truth statuses.
export const EVENT_TYPES = Object.freeze({
  ...
  LINEAGE_RECORD_CREATED: "lineage_record_created",

  VERIFICATION_PACKAGE_CREATED: "verification_package_created",
  VERIFICATION_RECORD_APPROVED: "verification_record_approved",
  VERIFICATION_RECORD_REJECTED: "verification_record_rejected",

  RECONCILIATION_CONFLICT_DETECTED: "reconciliation_conflict_detected",
  RECONCILIATION_CONFLICT_RESOLVED: "reconciliation_conflict_resolved",

  ORACLE_TRUTH_GENERATED: "oracle_truth_generated",
  TRUST_ENVELOPE_GENERATED: "trust_envelope_generated",

  REPORT_READINESS_EVALUATED: "report_readiness_evaluated",
  REPORT_ARTIFACT_CREATED: "report_artifact_created",
