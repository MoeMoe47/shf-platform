...
export const OGL_ORIENTATION_CONTRACTS = Object.freeze([
  ...
  },
  {
    ...
    checklist: [{ itemId: "review-evidence-request", label: "Review the evidence request", required: true, completionSource: "DGAL_REQUIREMENT", sourceRef: source("DGAL_REQUIREMENT", "civicsure:provider:evidence"), action: route("civicsure", "civicsure.provider.evidence") }],
    ...
    safeActions: { openWorkspace: route("civicsure", "civicsure.provider.workspace") },
    accessibility: commonAccessibility,
    telemetryEvents: events,
    changeClassification: "WORKFLOW_SIGNIFICANT",
    reorientation: { policy: "RECOMMENDED", triggerOn: ["WORKFLOW_SIGNIFICANT"] },
  ...
  },
  {
    ...
    checklist: [{ itemId: "review-current-queue", label: "Review the current assurance queue", required: true, completionSource: "DOMAIN_STATE", sourceRef: source("CIVICSURE_VERIFICATION", "review-queue"), action: route("civicsure", "civicsure.operator.verification") }],
    ...
    safeActions: { openReviewQueue: route("civicsure", "civicsure.operator.verification") },
    accessibility: commonAccessibility,
    telemetryEvents: events,
    changeClassification: "WORKFLOW_SIGNIFICANT",
    reorientation: { policy: "RECOMMENDED", triggerOn: ["WORKFLOW_SIGNIFICANT"] },
