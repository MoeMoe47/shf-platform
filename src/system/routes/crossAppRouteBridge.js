...
export const routeOwnership = Object.freeze({
  shrv1: Object.freeze([
    ...
    { key: "durablePersistence", route: "admin.html#/ops/persistence", owner: "shrv1", access: "admin" },
    { key: "trackingIntelligence", route: "admin.html#/ops/tracking", owner: "shrv1", access: "admin" },
    { key: "systemRegistryDependencyIntelligence", route: "admin.html#/ops/system-registry", owner: "shrv1", access: "admin" },
    { key: "commandBus", route: "admin.html#/ops/command-bus", owner: "shrv1", access: "admin" },
    { key: "eventBusMessageFabric", route: "admin.html#/ops/event-bus", owner: "shrv1", access: "admin" },
    { key: "jobScheduler", route: "admin.html#/ops/scheduler", owner: "shrv1", access: "admin" },
    { key: "notificationAlertFabric", route: "admin.html#/ops/notifications", owner: "shrv1", access: "admin" },
    { key: "executiveCommandCenter", route: "admin.html#/ops/executive-command", owner: "shrv1", access: "admin" },
    { key: "identityAccessCenter", route: "admin.html#/ops/identity-access", owner: "shrv1", access: "admin" },
...
export const shrv1RoutesToSmoke = Object.freeze([
  ...
  "admin.html#/ops/identity-access",
  "admin.html#/registry",
