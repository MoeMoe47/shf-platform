...
const curriculum = String(process.env.SHS_TEST_COMPLETION_CURRICULUM || "data-center-systems-7");
const completionLessons = JSON.parse(process.env.SHS_TEST_COMPLETION_LESSONS || JSON.stringify([
  "data-center-systems-7-systems-working-together",
  "data-center-systems-7-power-path",
  "data-center-systems-7-systems-challenge",
]));

test("representative Grade 7 lessons complete through the disposable API", {
