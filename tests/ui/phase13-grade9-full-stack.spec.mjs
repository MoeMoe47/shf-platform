...
const curriculum = String(process.env.SHS_TEST_COMPLETION_CURRICULUM || "data-center-technical-foundations-9");
const completionLessons = JSON.parse(process.env.SHS_TEST_COMPLETION_LESSONS || JSON.stringify([
  "data-center-technical-foundations-9-modern-server-hardware",
  "data-center-technical-foundations-9-network-fundamentals",
  "data-center-technical-foundations-9-safe-technical-system-project",
]));

test("representative Grade 9 lessons complete through the disposable API", {
