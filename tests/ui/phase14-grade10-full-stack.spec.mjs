...
const curriculum = String(process.env.SHS_TEST_COMPLETION_CURRICULUM || "data-center-reliable-operations-10");
const completionLessons = JSON.parse(process.env.SHS_TEST_COMPLETION_LESSONS || JSON.stringify([
  "data-center-reliable-operations-10-monitoring-alerts-logs",
  "data-center-reliable-operations-10-linux-operations",
  "data-center-reliable-operations-10-operations-challenge",
]));

test("representative Grade 10 operations lessons complete through the disposable API", {
