  ...
  build: {
    ...
    rollupOptions: {
      ...
      capital: path.resolve(__dirname, "capital.html"),
        ...
        oas: path.resolve(__dirname, "oas.html"),
        "oas-1": path.resolve(__dirname, "oas-1.html"),
        "oas-control-domains": path.resolve(__dirname, "oas-control-domains.html"),
        "oas-purpose-boundaries": path.resolve(__dirname, "oas-purpose-boundaries.html"),
        "oas-risk-classification": path.resolve(__dirname, "oas-risk-classification.html"),
